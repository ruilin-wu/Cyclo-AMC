...
public:
        //layer0-stem
        stem<1,0,0,0,1> stem_graph;
        input_plio      stem_weight;
        input_plio      stem_image; //fam_out
        output_plio     stem_out;

        //layer1
        layer1_block0_1memout<3,0,0,0,1> layer1_graph_0;
        layer1_block0_1memout<6,0,0,0,1> layer1_graph_1;    
        ...
        //layer2
        layer2_block0_1memout<16,0,0,0,1> layer2_graph_0;
        layer2_block1_1memout<19,0,0,0,1> layer2_graph_1;
        ...
        //layer3
        layer3_block0_1memout<25,0,0,0,1> layer3_graph_0;
        layer3_block1_1memout<28,0,0,0,1> layer3_graph_1;
        ...
        //layer4
        layer4_block0_1memout<32,0,0,0,1> layer4_graph_0;
        layer4_block1_1memout<35,0,0,0,1> layer4_graph_1;
        ...
        //layer5-head
        layer5_head_1out<3,6,0,0,0> head_graph;
