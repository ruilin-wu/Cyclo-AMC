...
public:
        //fam
        fam_top<2,4,0> fam_graph;
        input_plio      input_image;
        //output_plio     fam_output[1];

        //layer0-stem
        stem_alter<7+3-1-1,0,0,0,1> stem_graph;
        input_plio      stem_weight;
        //input_plio      stem_image; //fam_out
        //output_plio     stem_out;

        //layer1
        layer1_block0_1memout<7+5-1-1,0,0,0,1> layer1_graph_0;
        layer1_block0_1memout<7+3+5-1-1,0,0,0,1> layer1_graph_1;    
        ...
        //layer2
        layer2_block0_1memout<16+2-1-1,0,0,0,1> layer2_graph_0;
        layer2_block1_1memout<19+2-1-1,0,0,0,1> layer2_graph_1;
        ...
        //layer3
        layer3_block0_1memout<24-1-1,0,0,0,1> layer3_graph_0;
        layer3_block1_1memout<27-1-1,0,0,0,1> layer3_graph_1;
        ...
        //layer4
        layer4_block0_1memout<31-1-1-1,0,0,0,1> layer4_graph_0;
        layer4_block1_1memout<34-1-1-1,0,0,0,1> layer4_graph_1;
    ...
    dut(){
        ...
        connect<>(fam_graph.output[0],stem_graph.input_image[0]);
        connect<>(fam_graph.output[1],stem_graph.input_image[1]);
        connect<>(fam_graph.output[2],stem_graph.input_image[2]);
