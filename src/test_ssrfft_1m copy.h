...
public:
    ...
    dut(){
        ...
        connect<>(layer1_0_conv1_weight[i].out[0], layer1_graph0.input_weight_0_conv1[i]);
        connect<>(layer1_0_down_weight[i].out[0], layer1_graph0.input_weight_0_down[i]);
        connect<>(layer1_0_conv2_weight[i].out[0], layer1_graph0.input_weight_0_conv2[i]);
        ...
        connect<>(layer1_1_conv1_weight[i].out[0], layer1_graph1.input_weight_0_conv1[i]);
        connect<>(layer1_1_down_weight[i].out[0], layer1_graph1.input_weight_0_down[i]);
        connect<>(layer1_1_conv2_weight[i].out[0], layer1_graph1.input_weight_0_conv2[i]);
        }
                
        //input to block0
        layer1_input = input_plio::create("layer1_input", plio_32_bits, "data_input/layer1datain.txt", PLFreq);
        connect<>(layer1_input.out[0], layer1_graph0.input_image);
        //block0 to block1
        connect<>(layer1_input.out[0], layer1_graph1.input_image);
        //connect<>(layer1_graph0.output[0],layer1_graph1.input_image); 
        //block1 to output
        layer1_out[0] = output_plio::create("layer1_out0", plio_32_bits, "data_output/layer1_out0.txt", PLFreq);
        connect<>(layer1_graph0.output[0],layer1_out[0].in[0]); 
        layer1_out[1] = output_plio::create("layer1_out1", plio_32_bits, "data_output/layer1_out1.txt", PLFreq);
        connect<>(layer1_graph1.output[0],layer1_out[1].in[0]); 
